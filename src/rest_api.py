...
class RestApi():
    ...
    def __init__(self, config):
        ...
        def init_route():#usage: /init?streamtype=vissim&streamid=streamVissim1&templatetype=traffic-json&templateid=substreamVissim1
            #input parameters
            streamType=request.args.get('streamtype', default = "sumo", type = str) # vissim
            streamID=request.args.get('streamid', default = "streamSumo1", type = str) # streamVissim1
            ...
            #init player
            self.player=PlayerClass(self.config["streams"][streamType][streamID], templates) # self.config["templates"][templateType][templateID]
